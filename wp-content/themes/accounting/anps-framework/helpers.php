...
function anps_get_header() {
    ...
    ?>
        <header class="site-header-sticky-active site-header<?php echo esc_attr($anps_header_styles); ?><?php if(get_option('anps_main_menu_selection', '0')=='0' && !$is_vertical) { echo ' site-header-divider'; } ?>"<?php echo $header_style;?>>
