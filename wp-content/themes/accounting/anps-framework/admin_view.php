...
<?php $themever = wp_get_theme(get_template()); $version = $themever["Version"]; ?>
    <ul class="envoo-admin-menu">
        ...
        <li>
            <a <?php if (isset($_GET['sub_page']) && $_GET['sub_page'] == "import_export_widgets")
                        echo 'id="selected-menu-item"'; ?> href="themes.php?page=theme_options&sub_page=import_export_widgets"><i class="fa fa-file-code-o"></i><?php _e("Import/export widgets", 'accounting'); ?></a>
        </li>
        <li>
        ...
        switch($_GET['sub_page']) {
            ...
            case 'import_export_widgets': include_once 'import_export_widgets_view.php'; break;
