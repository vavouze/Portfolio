...
<form action="themes.php?page=theme_options&sub_page=options_media&save_media" method="post">
    ...
    <div class="content-inner">
        ...
        <!-- Mobile Logo -->
        <div class="input onehalf floatleft anps_upload">
            <label for="anps_mobile_logo"><?php esc_html_e('Mobile logo', 'accounting'); ?></label>
            <?php if(anps_get_option($anps_media_data, 'mobile_logo') != ''): ?>
                <div class="preview"><img src="<?php echo anps_get_option($anps_media_data, 'mobile_logo'); ?>"></div>
            <?php endif; ?>

            <input id="anps_mobile_logo" type="text" size="36" name="anps_mobile_logo" value="<?php echo anps_get_option($anps_media_data, 'mobile_logo'); ?>" />
            <input id="_btn" class="upload_image_button" type="button" value="Upload" />
            <p class="fullwidth"><?php esc_html_e('Enter an URL or upload an image.', 'accounting'); ?></p>
        </div>
        <!-- Favicon -->
        <div class="input onehalf anps_upload">
