...
$left_sidebar = get_option('anps_page_sidebar_left', get_option('page_sidebar_left'));
...
$right_sidebar = get_option('anps_page_sidebar_right', get_option('page_sidebar_right'));
